...
//  ViewPager
//
//  Created by Umer Yasin on 6/26/16.
...
public class ViewPager: UIView {
    ...
    func setupPageControl() {
        ...
        self.pageControl.pageIndicatorTintColor = UIColor(named: "currentDotWidth")
        self.pageControl.currentPageIndicatorTintColor = UIColor(named: "selectedBlackColor")
    ...
    func loadViewAtIndex(index:Int){
        ...
        DispatchQueue.main.async { [self] in
            dataSource?.currentIndex(index: pageControl.currentPage)
