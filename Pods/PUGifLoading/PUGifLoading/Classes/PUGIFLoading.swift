...
public class PUGIFLoading
{
    ...
    public func show(_ loadingText : String?, gifimagename: String?, iWidth:CGFloat,iHight:CGFloat)
    {
        ...
        if let keyWindow = UIWindow.key
        {
            ...
            whiteBackground.frame = CGRect(x: 20.0, y: 50.0, width: iWidth - 30, height: iHight - 30)
            ...
            lottieAnimationView.animation = LottieAnimation.named("fastLoader")
            lottieAnimationView.loopMode = .loop
//            lottieAnimationView.loopMode = .repeat(2)
            lottieAnimationView.frame = CGRect(x: 20.0, y: 50.0, width: iWidth, height: iHight)
            lottieAnimationView.center = overlay.center;
            lottieAnimationView.play()
            overlay.addSubview(lottieAnimationView)
